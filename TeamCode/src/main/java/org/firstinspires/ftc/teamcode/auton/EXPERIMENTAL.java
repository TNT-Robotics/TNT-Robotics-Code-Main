...
public class EXPERIMENTAL extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory idk1 = drive.trajectoryBuilder(drive5.end())
                ...
                .build();
        // CYCLE START
        Trajectory drive6 = drive.trajectoryBuilder(idk1.end().plus(new Pose2d(0, 0, Math.toRadians(180))))
                .back(7.3)
                .addDisplacementMarker(() -> {
                    updateClawServo(clawServo);
                })
        ...
        Trajectory drive8 = drive.trajectoryBuilder(drive7.end().plus(new Pose2d(0, 0, Math.toRadians(90))))
                .strafeRight(13)
                .addDisplacementMarker(() -> {
                    updateClawServo(clawServo);
                    /*if (runtime.milliseconds() > msTimeMarker + 750) {
